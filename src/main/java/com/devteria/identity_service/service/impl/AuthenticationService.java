...
import static com.devteria.identity_service.exception.ErrorCode.*;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        User user = userRepository.findByName(request.getName()).orElseThrow(() -> new AppException(USER_NOT_EXISTED));
    ...
    public AuthenticationResponse refreshToken(RefreshTokenRequest request)
        ...
        var user = userRepository.findByName(username).orElseThrow(()-> new AppException(UNAUTHENTICATED));
        return AuthenticationResponse.builder()
                .authenticated(true)
                .token(generateToken(user))
                .build();
